<%@ Page Title="" Language="C#" MasterPageFile="~/DSED08.master" AutoEventWireup="true" CodeFile="deals-and-offers-detail.aspx.cs" Inherits="product_deals_and_offersdetail" %>
                            ...
                            <div class="section">
                                <div class="product-detail-right">
                                    ...
                                    <div class="price">
                                        ...
                                        <span class="product-code" runat="server" id="spnperweek">
                                            <br />
                                            Per Week: $<asp:Literal runat="server" ID="ltrPerweek"></asp:Literal></span>
                                    </div>
                                </div>
                                <div class="product-code-availability border-bottom">
                                    <span class="product-code">Deal code:</span> <span>
                                        <asp:Literal runat="server" ID="ltrPCode"></asp:Literal></span>&nbsp; &nbsp;
                                <%-- <span class="product-code">Availability:</span> <span><asp:Literal runat="server" ID="ltrStockout"></asp:Literal></span>--%>
                                </div>
                                <div class="quick-review border-bottom" id="div_Description" runat="server" visible="false">
                                    <h2>Description</h2>
                                    <p class="content">
