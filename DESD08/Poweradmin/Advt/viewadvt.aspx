<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewadvt.aspx.cs" Inherits="Poweradmin_teaser_viewteaser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>Advertisement Banner Management</span>
            </li>
        </ul>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Advertisement Banner</span>
                            </div>
                            <div class="actions">                            
                                <a  href="manageadvt.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Advertisement Banner </span></a>
                                <div class="btn-group">                                      
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><asp:Button ID="lb_Active" OnClientClick="return SelectAction(this,'Are you sure you want to change status to active selected record?');" CssClass="link-button" runat="server" CommandName="active" Text="Visible Selected" OnClick="lb_Action_Click"></asp:Button></li>
                                        <li><asp:Button ID="lb_Deactive" OnClientClick="return SelectAction(this,'Are you sure you want to change status to deactive selected record?');" CssClass="link-button" runat="server" CommandName="deactive" Text="Hide Selected" OnClick="lb_Action_Click"></asp:Button></li>
                                        <li><asp:Button ID="lb_Delete" OnClientClick="return SelectAction(this,'Are you sure you want to delete selected record?');"  CssClass="link-button" runat="server" CommandName="delete" Text="Delete Selected" OnClick="lb_Action_Click"></asp:Button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-container">
                             ...
                             <asp:ListItem Text="200" Value="200"></asp:ListItem>
                                            ...
                                            <td style="border: none;">
                                                <asp:DropDownList ID="ddlPostion" runat="server" aria-controls="dataTables-example" CssClass="form-control input-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlPostion_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Value="3">Bottom</asp:ListItem>
                                                 ...
                                                 <small><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlPostion" ErrorMessage="Position is required" Display="Dynamic" ValidationGroup="vgSearchValidate3"></asp:RequiredFieldValidator></small>
                                            </td>
                                            <td style="border: none;">
                                            ...
                                            <td style="border: none;">
                                                <div class="margin-bottom-5">
                                                    <asp:LinkButton runat="server" ID="lbSearch" OnClick="lbSearch_Click" class="btn btn-sm btn-success filter-submit margin-bottom" ValidationGroup="vgSearchValidate3" >
                                                                    <i class="fa fa-search"></i></asp:LinkButton>
                                                 <asp:ValidationSummary ID="vsm1" runat="server" ShowMessageBox="false" ShowSummary="false" HeaderText="Please enter below details properly" ValidationGroup="vgSearchValidate3" />
                                               
                                                   <asp:LinkButton runat="server" ID="lbReset" OnClick="lbReset_Click" Visible="true" class="btn btn-sm btn-default filter-cancel">
                                                                <i class="fa fa-times"></i></asp:LinkButton> </div>
                                            </td>
                                        </tr>
                                            ...
                                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand"  OnItemDataBound="rep_ItemDataBound">
                                                <ItemTemplate>
                                                     <tr role="row" class="odd">
                                                       <td>
                                                        <asp:HiddenField ID="hfLayoutId" runat="server" Value='<%#Eval("id") %>' />
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                            <asp:CheckBox ID="checkboxDelete" runat="server" /><span></span></label>
                                                    </td>
                                                    <td data-th="Image"><%#GetImage(Eval("image").ToString()) %>
                                                         <td data-th="Position"><%#Eval("position").ToString().Replace("1","<span class='label label-success label-sm'>Side</span>").Replace("2","<span class='label label-primary label-sm'>Middle</span>").Replace("3","<span class='label label-warning label-sm'>Bottom</span>") %></td>
                                                        <td data-th="Visible"><%#Eval("Visible").ToString().Replace("True","<span class='label label-info label-sm'>Yes</span>").Replace("False","<span class='label label-danger label-sm'>No</span>") %></td>
                                                            ...
                                                            <div class="mt-action-buttons ">
                                                                <div class="btn-group btn-group-circle">
                                                                      <a href='manageadvt.aspx?id=<%#Eval("id") %>' class="btn btn-outline green btn-sm"><i class="fa fa-pencil"></i></a>
