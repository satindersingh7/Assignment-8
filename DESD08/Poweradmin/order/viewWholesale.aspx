<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewWholesale.aspx.cs" Inherits="Poweradmin_order_viewWholesale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>Wholesale Order Management</span>
            </li>
        </ul>
                                        ...
                                        <thead>
                                            <asp:Panel runat="server" ID="pnlSearch" DefaultButton="lbSearch">
                                                ...
                                                <div class="input-group date date-picker margin-bottom-5" data-date-format="dd-M-yyyy">
                                                    ...
                                                    <td style="border:none">
                                                        <asp:DropDownList ID="ddl_Status" CssClass="form-control" OnSelectedIndexChanged="ddl_Status_SelectedIndexChanged" runat="server">
                                                ...
                                                <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand" OnItemDataBound="rep_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td data-th="Orderdate"><%#Convert.ToDateTime(Eval("addeddate")).ToString("MM-dd-yyyy hh:mm")%></td>
                                                            <td data-th="CustomerName"><%#Eval("cname").ToString()%></td>
                                                            <td data-th="Status"><%#Eval("status")+""==""||Eval("status")+""=="0"?"<strong><span class='text-danger'>Pending</span></strong>":"<strong><span class='text-success'>Completed</span></strong>"%></td>
                                                            ...
                                                            <td class="dt-body-right sorting_1">
                                                                <div class="mt-action-buttons ">
                                                                    <div class="btn-group btn-group-circle">
                                                                        <a href='managewsorder.aspx?id=<%#Eval("id") %>' class="btn btn-outline green btn-sm"><i class="fa fa-eye"></i></a>
