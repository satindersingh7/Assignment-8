...
public partial class Poweradmin_Enquiry_viewenquiry : System.Web.UI.Page
{
    int findex, lindex;
    public static int pageindex = 0, Pagesize = 25;
    string strQuery, TableName = "Contactus", MessageNm = "Enquiry";
    ...
    protected void fill_Data()
    {
        ...
        if (tbx_Date.Text != "") strQuery += " and date(EDate)='" + DateTime.Parse(tbx_Date.Text.Replace("'", "''")).ToString("yyyy-MM-dd") + "'";
