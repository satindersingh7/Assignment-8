<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewenquiry.aspx.cs" Inherits="Poweradmin_Enquiry_viewenquiry" %>
            ...
            <div class="portlet light portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">View Enquiry</span>
                    </div>
                    <div class="actions">
                                            ...
                                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand" OnItemDataBound="rep_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td data-th="Name"><%#Eval("Name").ToString() + ((Eval("unread").ToString() == "1")? "<div class='tooltip right' role='tooltip' style='opacity:100;display:inline-block;'> <div class='tooltip-arrow'></div> <div class='tooltip-inner'> New ! </div> </div>" : "") %></td>
                                                        <td data-th="Email"><%#Eval("email").ToString() %></td>
                                                        <td data-th="Date"><%#DateTime.Parse(Eval("EDate").ToString()).ToString("dd-MMM-yyyy") %></td>
