...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        string[] arr_app_Phy_Path = Request.ServerVariables["APPL_PHYSICAL_PATH"].Split(new char[] { '\\' }, StringSplitOptions.RemoveEmptyEntries);
        string phyDir = arr_app_Phy_Path[arr_app_Phy_Path.Length - 1];

        if (url.StartsWith("/" + phyDir))
        {
            UserFilesPath = "/" + phyDir + "/userfiles/";
        }
        else
