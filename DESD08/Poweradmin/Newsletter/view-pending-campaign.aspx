<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="view-pending-campaign.aspx.cs" Inherits="Poweradmin_Newsletter_view_pending_campaign" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Pending Campaign</span>
                            </div>
                            <div class="actions"> 
                                <a  href="manage-campaign.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Campaign </span></a>                            
                                <div class="btn-group">                                      
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="">
                                    <thead>
                                        ...
                                        <%--<tr role="row" class="filter">
                                            ...
                                            <td><asp:TextBox ID="tbx_SearchMobile" runat="server" CssClass="form-control input-sm" placeholder="" aria-controls="dataTables-example"></asp:TextBox></td>
                                            <td>
                                        ...
                                        <asp:Panel ID="pnl_Record" runat="server">
                                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand"  OnItemDataBound="rep_ItemDataBound">
                                                <ItemTemplate>
                                                     ...
                                                     <td data-th="Campaign Subject"><%#Eval("subject").ToString()%></td>
                                                        <td data-th="Pending"><%#Eval("pending").ToString()%></td>
                                                        <td data-th="Sent"><%#Eval("sent").ToString()%></td>
                                                        <td data-th="Total"><%#Eval("subscribercnt").ToString()%></td>                                                       
                                                   <td class="dt-body-right sorting_1">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                        <li><a href='campaigndetail.aspx?id=<%#Eval("id") %>'>View Details</a></li>                                          
