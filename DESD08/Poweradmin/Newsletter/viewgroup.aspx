<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewgroup.aspx.cs" Inherits="Poweradmin_Newsletter_viewgroup" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Group</span>
                            </div>
                            <div class="actions"> 
                                <a  href="manage-group.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Group </span></a>                            
                                <div class="btn-group">                                      
                                            ...
                                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand"  OnItemDataBound="rep_ItemDataBound">
                                                <ItemTemplate>
                                                     <tr role="row" class="odd">
                                                      ...
                                                      <td data-th="Name"><%#Eval("Title").ToString()%></td>                                                        
                                                   <td class="dt-body-right sorting_1">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                        <li><a href='manage-group.aspx?id=<%#Eval("id") %>'>Edit</a></li>                                          
