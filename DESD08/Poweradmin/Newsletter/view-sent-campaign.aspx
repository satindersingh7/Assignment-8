<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="view-sent-campaign.aspx.cs" Inherits="Poweradmin_Newsletter_view_sent_campaign" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Sent Campaign</span>
                            </div>
                            <div class="actions"> 
                                    ...
                                    <thead>
                                        <tr role="row" class="heading">
                                            <td>
                                                ...
                                                <th width="80%">Campaign Subject</th>                                              
                                                <th></th>
                                        </tr>
