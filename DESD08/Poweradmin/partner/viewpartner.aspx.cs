...
public partial class Poweradmin_Partner_viewPartner : System.Web.UI.Page
{
    int findex, lindex;
    public static int pageindex = 0, Pagesize = 25;
    string strQuery, TableName = "Partner", MessageNm = "Partner";
    ...
    protected bool Delete_Data(string id)
    {
        try
        {
            ...
            try
            {
                if (File.Exists(DAL.GetRootPath() + "\\webfiles\\Partner\\" + FileName))
                    File.Delete(DAL.GetRootPath() + "\\webfiles\\Partner\\" + FileName);
    ...
    protected string GetImage(string image)
    {
        ...
        string path = "";
           if (image == "")
            ...
            {
                path = "<img src='../../webfiles/Partner/" + image + "' class='img-responsive' style='height: 88px !Important; width:270px' />";
            }
          return path;
