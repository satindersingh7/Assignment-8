<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="managebanner.aspx.cs" Inherits="Poweradmin_Banner_manageBanner" %>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <small>[File with .jpg, .gif, .png, .jpeg, .bmp extensions / formats only.]<br />
                                        ...
                                        [Recommended Dimension - Width : <%=ConfigurationManager.AppSettings["BannerImgWidth"]%>px - Height :<%=ConfigurationManager.AppSettings["BannerImgHeight"]%>px]</small><br />
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 900px; height: 250px;">
                            ...
                            <div class="form-group form-md-line-input form-md-floating-label">
                                ...
                                <div class="col-md-10">
                                    <asp:TextBox ID="txtURL" runat="server" MaxLength="400" CssClass="form-control maxlength-handler"></asp:TextBox>
