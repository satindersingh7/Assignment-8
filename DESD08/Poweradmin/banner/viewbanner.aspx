<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewbanner.aspx.cs" Inherits="Poweradmin_Banner_viewBanner" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Banner </span>
                            </div>
                            <div class="actions">                            
                                <a  href="manageBanner.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">Banner </span></a>
                                <div class="btn-group">                                      
                             ...
                             <asp:ListItem Text="200" Value="200"></asp:ListItem>
                                   ...
                                   <td class="dt-body-right sorting_1">   <div class="mt-action-buttons ">
                                                                <div class="btn-group btn-group-circle">
                                                                      <a href='manageBanner.aspx?id=<%#Eval("id") %>' class="btn btn-outline green btn-sm"><i class="fa fa-pencil"></i></a>
