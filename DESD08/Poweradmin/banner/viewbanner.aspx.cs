...
public partial class Poweradmin_Banner_viewBanner : System.Web.UI.Page
{
    int findex, lindex;
    public static int pageindex = 0, Pagesize = 25;
    string strQuery, TableName = "Banner", MessageNm = "Banner";
    ...
    protected bool Delete_Data(string id)
    {
        try
        {
            ...
            try
            {
                if (File.Exists(DAL.GetRootPath() + "\\webfiles\\Banner\\" + FileName))
                    File.Delete(DAL.GetRootPath() + "\\webfiles\\Banner\\" + FileName);
    ...
    protected string GetImage(string image)
    {
        ...
        string path = "";
           if (image == "")
            ...
            {
                path = "<img src='../../webfiles/Banner/" + image + "' class='img-responsive' style='height: 150px !Important; width:270px' />";
            }
          return path;
