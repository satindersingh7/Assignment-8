                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Products </span>
                            </div>

                            <div class="actions">

                                <a href="import-product.aspx" class="btn btn-circle btn-warning">
                                    <i class="fa fa-plus"></i>
                                    <span class="hidden-xs">Import Products </span>
                                </a>
                                        ...
                                        <thead>
                                            <asp:Panel runat="server" ID="pnlSearch" DefaultButton="lbSearch">
                                                <tr role="row" class="filter form-group form-md-line-input ">
                                                    ...
                                                    <td style="border: none;">
                                                        <asp:TextBox ID="tbx_Search" runat="server" placeholder="Product name" CssClass="form-control form-filter input-sm"></asp:TextBox>
                                                    ...
                                                    <td style="border: none;">
                                                     ...
                                                     <td style="border: none;">
                                                        <asp:DropDownList ID="ddlstockout" runat="server" aria-controls="dataTables-example" CssClass="form-control input-sm">
                                                            <asp:ListItem Value="">Select</asp:ListItem>
                                                            <asp:ListItem Value="1">Yes</asp:ListItem>
                                                            <asp:ListItem Value="0">No</asp:ListItem>
                                                        </asp:DropDownList></td>
                                                ...
                                                <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand" OnItemDataBound="rep_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td data-th="Product Name"><%#Eval("Title").ToString().Length>30 ? Eval("Title").ToString().Replace("''", "'").Substring(0,27)+"..." : Eval("Title").ToString().Replace("''", "'") %></td>
                                                            ...
                                                            <td data-th="Out of Stock"><%#Eval("outofstock").ToString().Replace("True","<span class='label label-danger label-sm'>Yes</span>").Replace("False","<span class='label label-info label-sm'>No</span>") %></td>
                                                            <%if(ddl_Category.SelectedValue.ToString()!=""){ %>
