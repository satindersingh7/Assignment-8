                ...
                <div class="portlet-title tabbable-line">
                    <ul class="nav nav-tabs pull-left">
                        ...
                        <li class="<%=Associate.ToString()%>" runat="server" id="tabAssociate">
                            <a href="#portlet_tab2_3" data-toggle="tab">Associate Products</a>
                        </li>
                    </ul>
                </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <label class="col-md-4 control-label">Product Code:<span class="red"> * </span></label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group row form-md-line-input form-md-floating-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="rfv_ProductImage" runat="server" ControlToValidate="fulp" ErrorMessage="Product Image is required" SetFocusOnError="true" Display="Dynamic" ValidationGroup="vgValidate"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-horizontal form-row-seperated">
                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-tags font-green"></i>
                                            <span class="caption-subject font-green sbold uppercase">Existing Product Images </span>
                                        </div>
                                        <div class="actions btn-set">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2 control-label">Upload Multiple Product Images</label>
                                                        <div class="col-md-10">
                                                            <small>[File with .jpg, .gif, .png, .jpeg, .bmp extensions / formats only.]<br />
                                                                [Maximum Image Size: <%= ConfigurationManager.AppSettings["ImageSize"]%> MB]<br />
                                                                [Recommended Dimension - Width : <%=ConfigurationManager.AppSettings["ProductImgWidth"]%>px - Height :<%=ConfigurationManager.AppSettings["ProductImgHeight"]%>px]</small><br />
                            ...
                            <div class="form-horizontal form-row-seperated">
                                <div class="portlet light portlet-fit portlet-datatable bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-tags font-green"></i>
                                            <span class="caption-subject font-green sbold uppercase">Existing Associate Products </span>
                                        </div>
                                        <div class="actions btn-set">
