<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewcategory.aspx.cs" Inherits="Poweradmin_ProductCategory_viewProductCategory" %>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Product Category </span>
                            </div>
                             <div class="actions">
                                    <a href="manageCategory.aspx" class="btn btn-circle btn-info btn-sm"><i class="fa fa-plus"></i><span class="hidden-xs">New Product Category </span></a>
                                    <div class="btn-group">
                                                        ...
                                                        <td class="dt-body-right sorting_1">
                                                            <div class="mt-action-buttons ">
                                                                <div class='btn-group btn-group-circle'>
                                                                    <a href='manageCategory.aspx?id=<%#Eval("id") %>' class="btn btn-outline green btn-sm"><i class="fa fa-pencil"></i></a>
                                                                    <span style="position: relative;" class="btn btn-outline red btn-sm" runat="server">
