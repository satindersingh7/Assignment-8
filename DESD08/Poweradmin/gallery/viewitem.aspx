<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewitem.aspx.cs" Inherits="Poweradmin_Photo_viewPhoto" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Photo / Videos </span>
                            </div>
                            <div class="actions">
                                <a href="manageitem.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Photo </span></a>
                                <div class="btn-group">
                                            ...
                                            <asp:Repeater ID="rep" runat="server" OnItemDataBound="rep_ItemDataBound" OnItemCommand="rep_ItemCommand">
                                                <ItemTemplate>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td data-th="Photo"><b><%# Eval("title") %></b>
                                                            <%# Eval("contenttype").ToString() == "1" ? "<hr />"+GetImage(Eval("image").ToString())+"<br />" : ""%>
                                                            <%# Eval("contenttype").ToString() == "2" ? "<hr /><iframe width='400'  src='" + Eval("LinkURL").ToString() + "' frameborder='0' allowfullscreen></iframe><br />" : ""%>
                                                        </td>
