<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewalbum.aspx.cs" Inherits="Poweradmin_viewAlbum" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="managealbum.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Album </span></a>
                                <div class="btn-group">
