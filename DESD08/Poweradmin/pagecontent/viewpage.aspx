<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewpage.aspx.cs" Inherits="Poweradmin_pagecontent_viewpage" %>
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View Page</span>
                            </div>
                             <div class="actions">                            
                                <a  href="managepage.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New Page </span></a>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="">
                                    <thead>
                                        <tr role="row" class="heading">
                                                ...
                                                <th style="text-align:left;padding-left:5px;" width="50%">Page Name</th>  
                                             <th>Sort Order</th>
                                            <th>Edit</th>                                                                                  
                                                <th>Edit</th>     
                                        </tr>
                                    ...
                                    <tbody>
                                        <asp:Panel ID="pnl_Record" runat="server">
                                            ...
                                            <td class="center"><asp:HiddenField ID="hdnDisId" runat="server" Value='<%#Eval("sortorder") %>' />
                                            ...
                                            <td class="dt-body-right sorting_1"><a href='managepage.aspx?id=<%#Eval("id") %>' class="btn btn-info btn-sm">Edit</a></td>
                                            <td class="dt-body-right sorting_1"><asp:LinkButton  ID="ibDelete" OnClientClick="return confirm('Are you sure you want to delete this record?');" CommandName="Delete" CssClass="btn btn-danger btn-sm"  CommandArgument='<%#Eval("id")%>' runat="server" Text="Delete"></asp:LinkButton></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
                                        </asp:Panel>
