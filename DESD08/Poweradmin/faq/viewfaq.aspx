<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/admin.master" AutoEventWireup="true" CodeFile="viewfaq.aspx.cs" Inherits="Poweradmin_faq_viewfaq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green sbold uppercase">View FAQ</span>
                            </div>
                            <div class="actions">
                             <a  href="managefaq.aspx" class="btn btn-circle btn-info"><i class="fa fa-plus"></i><span class="hidden-xs">New FAQ </span></a>
                                <div class="btn-group">                                     
 ...
 <div class="table-container">
                             ...
                             <asp:ListItem Text="200" Value="200"></asp:ListItem>
                                            ...
                                            <td style="border: none;">
                                                <asp:TextBox ID="tbx_Search" runat="server"  CssClass="form-control input-sm" placeholder="Question" aria-controls="dataTables-example"></asp:TextBox>
                                               <small>
                                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ValidateBoxes" ControlToValidate="tbx_Search" Display="Dynamic" ErrorMessage="fill atleast one field." SetFocusOnError="True" ValidateEmptyText="true" ValidationGroup="vgSearchValidate1"></asp:CustomValidator>
                                                    </small>
                                            </td>                                            
                                            <td style="border: none;">
                                            ...
                                            <td style="border: none;">
                                                <div class="margin-bottom-5">
                                                          <span style="position: relative;" class="btn btn-sm btn-success filter-submit margin-bottom">
                                                            ...
                                                            <asp:Button runat="server" ID="lbSearch" OnClick="lbSearch_Click" class="movedown" ValidationGroup="vgSearchValidate1"></asp:Button></span>
                                                <asp:ValidationSummary ID="vsm1" runat="server" ShowMessageBox="false" ShowSummary="false" HeaderText="Please enter below details properly" ValidationGroup="vgSearchValidate1" />
                                        ...
                                        <asp:Panel ID="pnl_Record" runat="server">
                                            <asp:Repeater ID="rep" runat="server" OnItemCommand="rep_ItemCommand"  OnItemDataBound="rep_ItemDataBound">
                                                <ItemTemplate>
                                                    ...
                                                    <td data-th="Name"><%#Eval("Question").ToString().Length>50 ? Eval("Question").ToString().Substring(0,50)+"..." : Eval("Question").ToString() %></td>
                                           ...
                                           <td class="dt-body-right sorting_1">   <div class="mt-action-buttons ">
                                                                <div class="btn-group btn-group-circle">
                                                                      <a href='managefaq.aspx?id=<%#Eval("id") %>' class="btn btn-outline green btn-sm"><i class="fa fa-pencil"></i></a>
